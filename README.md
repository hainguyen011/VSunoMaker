...
**VSunoMaker.AI** là một Chrome Extension mạnh mẽ giúp tự động hóa quy trình sáng tác nhạc trên Suno.com. Với sự hỗ trợ của trí tuệ nhân tạo (Gemini API), extension mang đến tư duy nhạc lý chuyên sâu, giúp bạn tạo ra những bản hit chất lượng cao chỉ trong vài giây.
...
6. Chọn thư mục **VSunoMaker.AI** (thư mục chứa file `manifest.json`).

## 📖 Hướng Dẫn Sử Dụng

### 1. Cấu Hình Ban Đầu

* Click vào icon **VSunoMaker.AI** trên thanh công cụ trình duyệt.
